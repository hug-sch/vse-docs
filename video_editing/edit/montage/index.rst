...
.. Hint::
   ...
   The choice of the shortcuts (e.g. X for Delete) is of course inspired by the meaning of the operation but also by the fact that the shortcut must be easy to carry out with the left hand on a standard (Qwerty) keyboard. So, the preferred shortcut for Delete is not the :kbd:`Delete` key (which is on most keyboards on the right hand side) but the :kbd:`X` key.
